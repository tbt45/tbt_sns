                ...
                <div class="leading-loose">
                    <form method="POST" action="{{ route('login') }}" class="max-w-sm m-4 p-10 bg-white bg-opacity-25 rounded shadow-xl">
                        ...
                        <div class="">
                            ...
                            <input class="w-full px-5 py-1 text-gray-700 bg-gray-300 rounded focus:outline-none focus:bg-white" type="text" id="name" placeholder="名前" required autofocus>
                        </div>
                        <div class="">
                            <label class="block text-sm text-white" for="email">メールアドレス</label>
                            <input class="w-full px-5 py-1 text-gray-700 bg-gray-300 rounded focus:outline-none focus:bg-white" type="email" name="email" id="email" placeholder="メールアドレス" aria-label="email" required autofocus>
                        </div>
                        <div class="mt-2">
                        ...
                        <div class="mt-2">
                            ...
                            <input class="w-full px-5 py-1 text-gray-700 bg-gray-300 rounded focus:outline-none focus:bg-white" name="password_confirmation" type="password" id="password_confirmation" placeholder="パスワード確認" arial-label="password" required>
                        </div>
